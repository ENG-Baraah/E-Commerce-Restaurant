...
namespace TasteRestaurant.Pages.Cart
{
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            detailCart.OrderHeader.CommentsResName = detailCart.OrderHeader.CommentsResName;
            detailCart.OrderHeader.CommentsDesAdress = detailCart.OrderHeader.CommentsDesAdress;
            detailCart.OrderHeader.Comments = detailCart.OrderHeader.Comments;
